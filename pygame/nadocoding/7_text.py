...
#적 enemy 캐릭터
enemy =  pygame.image.load("C:\\workspace\\99_python\\pygame\\enemy.png")
...
#20fps : 1초 동안에 20번 동작 -> 1번이 5만큼 이동
...
#    screen.fill((0, 0, 255)) #rgb값으로 채우기
    ...
    #start_ticks = pygame.time.get_ticks() #현재 tick 을 받아옴
    #pygame.time.get_ticks() 는 실행될때 마다 시간을 받아와서 값이 계속 달라지기 때문에 같은것을 뺴는 것이 아니다.
